...
import { CalendarClock, CheckCircle, ArrowRight, User, Building2 } from 'lucide-react';
...
export const TodaysAgendaCard = ({ leads, onLeadClick, onMarkCompleted }: TodaysAgendaCardProps) => {
                ...
                <div className="flex items-center gap-2">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-slate-500 font-medium">
                            You have <span className="text-blue-600 font-bold">{leads.length}</span> follow-ups scheduled for today.
                        </p>
                    </div>
                </div>
            </CardHeader>
